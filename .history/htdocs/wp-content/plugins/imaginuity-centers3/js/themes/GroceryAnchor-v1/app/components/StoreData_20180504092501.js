                            ...
                            sales = saleData.map(function (sale) {
                                ...
                                if(typeof sale.acf.related_store !== 'undefined' && moment().isSameOrBefore(sale.acf.end_date) || nodate){
                                    ...
                                    if (saleStoreID === storeID) {
                                        hasSales.push(<div>
                                            <h3>
                                              <Link key={saleStoreID} onClick="jQuery('.modal').modal('hide')" to={"/sales/" + saleSlug}>
                                                {entities.decode(saleTitle)}
                                              </Link>
                                            </h3>
                                            <p>{excerpt ? excerpt + " [...]": ""}</p>
                                          </div>);
                ...
                <section className="store-details" >
                    ...
                    <Grid>
                        <Row>
                            <Col xs={8} xsOffset={2}>
                                {(this.state.URL) ?
                                    <p><a href={this.state.URL} target="_blank">{this.state.URL.replace(window.location.protocol + '//', '').replace('https://', '').replace('www.', '')}</a></p> : null}
                                {(this.state.image) ?
                        ...
                        <Row className="double-cta">
                            <Col xs={12} sm={6} smOffset={3} className="col background-color-setter-lighter border-color-setter-lighter" onClick={this.openSales.bind(this)}>
                                <h2>Sales & Offers</h2>
                            </Col>
                        </Row>
