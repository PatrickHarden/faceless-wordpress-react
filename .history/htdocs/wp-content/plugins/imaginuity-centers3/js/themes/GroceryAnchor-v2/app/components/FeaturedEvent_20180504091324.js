...
class FeaturedEvent extends Component{
    ...
    render(){
        ...
        if(this.state.data){
            ...
            return <div className="featured-event-single background-color-setter">
                ...
                <div className="copy-container">
                  <div className="title-container">
                    {this.state.featuredEvent.acf.related_store && <h4>
                    ...
                    <h2>
                      <Link to={"/events/" + this.state.featuredEvent.slug} key={this.state.featuredEvent.id}>
                        {entities.decode(this.state.event.acf.featured_event.post_title)}
                      </Link>
                    </h2>
                  </div>
                  <div className="date-container">
                    {dateRangeCheck ? <div className="date">
                        <h4>{startWeekday}</h4>
                        <h4>{singleStartMonth}</h4>
                      </div> : <div className="date date-range clearfix">
                        <div className="start">
                          <h4>{startWeekday}</h4>
