...
class SubmissionEvents extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        if(this.state.data){
            return (
                <div className="template-event-submission">
                    <Helmet
                        title={'Event Submission | ' + this.state.siteData.name + ' | ' + this.state.optionsData.acf.address_1 + ' ' + (this.state.optionsData.acf.address_2 ? this.state.optionsData.acf.address_2 + ' ' : '') + this.state.optionsData.acf.city + ', ' + this.state.optionsData.acf.state}
                        meta={[
                    ...
                    <EventsSubmission homeData={this.state.homeData} optionsData={this.state.optionsData} />
                    }
