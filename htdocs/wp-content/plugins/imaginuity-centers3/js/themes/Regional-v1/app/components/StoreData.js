                    ...
                    axios.get(Jobs)
                        .then(function (response) {
                            ...
                            jobs = jobData.map(function (job) {
                                let jobStoreID = job.acf.related_store.ID;
                                let jobTitle = job.title.rendered;
                        ...
                        .then((response) => {
                            ...
                            sales = saleData.map(function (sale) {
                                ...
                                if(typeof sale.acf.related_store !== 'undefined' && moment().isSameOrBefore(sale.acf.end_date) || nodate){
                                    let saleStoreID = sale.acf.related_store.ID;
                                    let saleTitle = sale.title.rendered;
                                    let saleSlug = sale.slug;
                                    let excerpt;
                            ...
                            if(data.acf.global_store_selector){
                                axios.get(SingleGlobalStore + data.acf.global_store_selector.selected_posts[0].ID)
                                    .then((store) => {
                                        ...
                                        let featuredImage = store.data.featured_image;
            ...
            return (
                <section className="store-details" >
                    ...
                    <Grid>
                        ...
                        <Row className={"double-cta" + (this.props.optionsData.acf.hide_jobs_cta ? " hide-jobs" : '') + (this.props.optionsData.acf.hide_sales_cta ? " hide-sales" : '')}>
                        ...
                        <div className="modal fade" id="jobs-modal" tabIndex="-1" role="dialog">
                        ...
                        <Row className="store-info">
                            {this.state.restaurantMenu ? ( // if there is a restaurant menu, print 4 columns, else print 3 columns
                                <div>
                                    ...
                                    <Col xs={12} sm={3}>
                                        {this.state.entranceIcon ? (
                                            <img src={this.state.entranceIcon} alt="Best store entrance"/>
                                        ) : (
                                            <svg id="best-entrance-icon" viewBox="0 0 165 165" className="border-color-setter font-color-setter" alt="best entrance">
                                                <circle className="cls-1" cx="82.5" cy="83.06" r="79.8"/>
                                                <text className="cls-2 background-color-setter" transform="translate(53.75 72.39)">BEST
                                                    <tspan className="cls-3 font-color-setter">
                                                        <tspan x="-35.65" y="29.83">ENT</tspan>
                                                        <tspan className="cls-4" x="11.24" y="29.83">R</tspan>
                                                        <tspan className="cls-5" x="27.07" y="29.83">ANCE</tspan>
                                                    </tspan>
                                                </text>
                                            </svg>
                                        )}
                                        <p className="font-color-setter">{this.state.entrance ? this.state.entrance : 'No best entrance available'}</p>
                                    </Col>
                                    <Col xs={12} sm={3}>
                                        <svg id="rest-menu-icon">
                                            <circle className="cls-1 border-color-setter" cx="82.5" cy="83.06" r="79.8"/>
                                            <path className="cls-2 background-color-setter"
                                ...
                                <div>
                                    ...
                                    <div className="hours-container border-color-setter">
                                        <Hours optionsData={this.props.storeData.acf.custom_hours ? this.props.storeData : this.props.optionsData} isStore={true} />
                                    </div>
