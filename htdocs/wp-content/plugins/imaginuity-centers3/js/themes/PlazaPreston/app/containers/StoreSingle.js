        ...
        if(this.state.data){
            return(
                <div className="store-single">
                    ...
                    />
                    <InteriorHeader
                        title={this.state.storeData.acf.title ? this.state.storeData.acf.title : this.state.storeData.title.rendered}
                        titleCopy={this.state.storeData.acf.title_copy}
                        color={this.state.storeData.acf.header_color_picker ? this.state.storeData.acf.header_color_picker : '#815883'}
                        aboveBelow={'below'}
                        imageMobile={this.state.storeData.acf.use_featured_image ? this.state.storeData.acf.header_featured_image_mobile : false}
                        imageDesktop={this.state.storeData.acf.use_featured_image ? this.state.storeData.acf.header_featured_image_desktop : false}
                    />
