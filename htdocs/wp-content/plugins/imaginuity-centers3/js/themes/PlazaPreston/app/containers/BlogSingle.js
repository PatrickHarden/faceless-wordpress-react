        ...
        if (this.state.data) {
            ...
            return (
                <section className="blog-single">
                    ...
                    <div
                        className="header"
                        style={{'backgroundColor': this.state.blogPageData.acf.header_color_picker ? this.state.blogPageData.acf.header_color_picker : '#908E7D'}}
                    >
                    ...
                    <div className="container">
                        <div className="column-left col-sm-12 col-md-6">
                            ...
                            <img className="foreground hidden-md hidden-lg"
