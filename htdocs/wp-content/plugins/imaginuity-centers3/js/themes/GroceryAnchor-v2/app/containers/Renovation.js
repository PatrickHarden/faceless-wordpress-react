...
// Map Imports
import Map from '../../lib/mapplic/js/mapplic';
import Hammer from '../../lib/mapplic/js/hammer.min';
import Mousewheel from '../../lib/mapplic/js/jquery.mousewheel';
import Popup from '../../lib/mapplic/js/magnific-popup';
//import MapCSS from '../../lib/mapplic/css/mapplic.css';
//import MapCSS2 from '../../lib/mapplic/css/map.css';
        ...
        axios.all([
            ...
            .then(axios.spread(function (site, home, pageData, options) {
                ...
                component.setState({
                    ...
                    enableSlider: pageData.data[0].acf.enable_home_slider,
                    pageData: pageData.data[0],
                    slides: component.buildSlides(pageData.data[0].acf.image_slider, 'hero'),
                    slideCount: pageData.data[0].acf.image_slider.length,
                    imageSlides: component.buildSlides(pageData.data[0].acf.image_slider_list, 'list'),
                    imageSlideCount: pageData.data[0].acf.image_slider_list.length,
