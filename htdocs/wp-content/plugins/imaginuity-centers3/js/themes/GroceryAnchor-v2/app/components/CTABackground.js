...
class CTABackground extends Component{
    ...
    render(){
        var buttonLink = (this.props.ctaData.acf.cta_button_link == 'Internal')? this.props.ctaData.acf.cta_internal_link : this.props.ctaData.acf.cta_external_link;
        return(
            <div
                    ...
                    <Row>
                        <Col xs={12}>
                            ...
                            {this.props.ctaData.acf.cta_content && 
                                <p style={{'color': 'white'}}> {this.props.ctaData.acf.cta_content}</p>
                            }
                            <Button className="border-color-setter font-color-setter" href={buttonLink}>{this.props.ctaData.acf.cta_button_text ? this.props.ctaData.acf.cta_button_text : ''}</Button>
                        </Col>
                    </Row>
                </Grid>
            </div>
