...
import ExclausiveOffers from "./ExclausiveOffers";
...
const Root = () => (
    <Router history={browserHistory} onUpdate={logPageView} >
        <Route path="/" component={Main}>
            ...
            <Route name="Movies" component={Movies} path="/movies" />
            <Route name="Search" component={Search} path="/search" />
            <Route name="Exclausive Offers" component={ExclausiveOffers} path="/exclausive-offers" />
