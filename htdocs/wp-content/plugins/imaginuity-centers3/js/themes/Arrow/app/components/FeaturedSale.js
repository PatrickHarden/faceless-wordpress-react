                ...
                return(
                    <div className="featured-sale-single background-color-setter">
                        <div className="img-container">
                            <img src={this.state.sale.acf.featured_sale_image.url} alt={(this.state.sale.acf.featured_sale_image.alt ? this.state.sale.acf.featured_sale_image.alt : 'featured image')}/>
                        </div>
                        <div className="copy-container">
                            <div className="title-container">
                                {this.state.featuredSale.acf.related_store &&
                                <h4>
                                    <Link to={"/stores/" + this.state.featuredSale.acf.related_store.post_name + "/"} key={this.state.featuredSale.acf.related_store.ID} >
                                        {entities.decode(this.state.featuredSale.acf.related_store.post_title )}
                                    </Link>
                                </h4>
                                }
                                <h2><Link to={"/sales/"+this.state.featuredSale.slug+"/"} key={this.state.featuredSale.id} >{entities.decode(this.state.sale.acf.featured_sale.post_title)}</Link></h2>
                            </div>
                            ...
                            <p>{excerpt} <Link to={"/sales/"+this.state.featuredSale.slug+"/"}>Read More</Link></p>
                        </div>
