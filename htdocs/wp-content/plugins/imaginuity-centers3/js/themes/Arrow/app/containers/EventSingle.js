    ...
    componentWillMount(){
        ...
        axios.all([
            ...
            .then(axios.spread(function(site, home, options, eventPageData, pageData) {
                ...
                let timeString = startTime !== endTime ? (startTime == 'TBD' && endTime == 'TBD' ? '' : startTime + ' - ' + endTime) : (startTime == 'TBD' ? 'TBD' : startTime );
                timeString = startTime == 'TBD' && endTime == 'TBD' ? '' : timeString;
