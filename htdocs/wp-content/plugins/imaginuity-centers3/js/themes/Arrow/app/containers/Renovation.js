        ...
        axios.all([
            ...
            .then(axios.spread(function (site, home, pageData, options){
                ...
                component.setState({
                    ...
                    tripleCTAs: pageData.data[0].acf.three_cta_section_enable_component ? component.buildTripleCTA(pageData.data[0].acf.cta_three_section) : false,
