...
class PageLayoutInformation extends Component{
    constructor(props){
        super(props);

        this.state = {
            layoutType: this.props.layout ? this.props.layout.acf_fc_layout : false,
        ...
        switch(this.state.layoutType){
            case 'full_width':
                layout =
                    <Row>
                        <Col xs={12}>
                            <section dangerouslySetInnerHTML={{ __html: entities.decode(this.state.layout.content_area)}} />
                        </Col>
                    </Row>;
                break;
...
export default PageLayoutInformation;