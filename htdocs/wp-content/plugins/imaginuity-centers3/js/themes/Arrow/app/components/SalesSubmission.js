...
class SalesSubmission extends Component{
    ...
    componentWillMount(){
        ...
        axios.all([
            ...
            .then(axios.spread(function(storeData, saletype){
                let storeQueries = [];
                if(storeData.headers['x-wp-totalpages'] > 1){
                    ...
                    axios.all(storeQueries)
                        .then((response) => {
                            ...
                            component.handleDataResponse(data, saletype);
                        })
                        .catch((err) => {
                    ...
                    component.handleDataResponse(storeData.data, saletype);
                }
            }))
            .catch((err) => {
                console.log('Error');
        ...
        axios.all([
            ...
            .then(axios.spread(function (storeData, saletypes) {
    ...
    handleDataResponse(storeData, saletypes){
        // Retrieve stores, sort alphabetically
    ...
    handleSubmit(sale) {
        ...
        if(!document.getElementById("honeypot").value && !errors) {
            let dataString = $("#sales-form-save").get(0);
        ...
        if(this.state.data){
                                ...
                                <Row>
                                    ...
                                    <div className="col-xs-12 col-md-6 form-group">
                                        ...
                                        <label for='start-date' className="col-xs-12">
                                            ...
                                            <Datetime inputProps={{ id: 'startDate', name: 'start-date'} } dateFormat="MM/DD/YYYY" timeFormat={false} onChange={(newDate) => {this.handleDateTimeChange(newDate, 'startDate')}} value={this.state.startDate} closeOnSelect={true} />
                                        </label>
                                    </div>
                                    ...
                                    <div className="col-xs-12 col-md-6 form-group">
                                        ...
                                        <label for='end-date' className="col-xs-12">
                                            ...
                                            <Datetime inputProps={{ id: 'endDate', name: 'end-date'} } dateFormat="MM/DD/YYYY" timeFormat={false} onChange={(newDate) => {this.handleDateTimeChange(newDate, 'endDate')}} value={this.state.endDate} closeOnSelect={true} />
                                        </label>
                                    </div>
            ...
            return(
                <Grid>
                    <Row>
                        <Col xs={12}>
                            <h2>An error occurred retrieving the Sale Submission form.</h2>
