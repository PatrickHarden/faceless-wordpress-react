                        ...
                        {this.state.printableDirectory &&
                            <div className="icon-container">
                                <OverlayTrigger placement="top" overlay={printableDirectory}>
                                    <a href={this.state.printableDirectory} className="pull-right print" title="printable directory" target="_blank">
                        ...
                        {this.props.optionsData.acf.enable_interactive_map &&
                            <div className="icon-container">
                                <OverlayTrigger placement="top" overlay={interactiveMap}>
                                    <a href="/interactive-map" className="pull-right map" title="interactive map">
