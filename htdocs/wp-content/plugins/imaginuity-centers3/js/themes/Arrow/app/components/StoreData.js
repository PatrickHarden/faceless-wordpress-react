...
import StoreSchema from '../components/schema/StoreScheme';
...
let Images = SiteURL + "/wp-content/plugins/imaginuity-centers3/js/themes/JLL/lib/img";
                                    ...
                                    if (saleStoreID === storeID) {
                                        hasSales.push(
                                            <div>
                                                ...
                                                <p>{excerpt}<Link onClick="jQuery('.modal').modal('hide')" to={'/sales/'+saleSlug+'/'}>Read More</Link></p>
                                            </div>
                                        );
                                    }
                                }
        ...
        if(this.state.data){
            ...
            return (
                <section className="store-details" >
                    <StoreSchema
                        centerName={entities.decode(this.props.siteData.name)}
                        storeName={entities.decode(this.props.storeData.title.rendered)}
                        restaurantMenu={this.props.storeData.acf.restaurant_menu ? this.props.storeData.acf.restaurant_menu : false}
                        address_1={this.props.optionsData.acf.address_1}
                        address_2={this.props.optionsData.acf.address_2}
                        city={this.props.optionsData.acf.city}
                        props={this.props.optionsData.props}
                        zip={this.props.optionsData.acf.zip}
                        description={entities.decode(this.props.storeData.acf.store_copy)}
                        telephone={this.props.storeData.acf.phone_number}
                        logo={this.state.storeLogo}
                        facebook={this.props.storeData.acf.facebook}
                        instagram={this.props.storeData.acf.instagram}
                        twitter={this.props.storeData.acf.twitter}
                        website={this.props.storeData.acf.website}
                        pinterest={this.props.storeData.acf.pinterest}
                        customHours={this.props.storeData.acf.alternate_hours ? this.props.storeData.acf.alternate_hours : false}
                                ...
                                <Col xs={12} sm={8} smOffset={2} className="page-header">
                                    {this.state.storeLogo ? (
                                        <span>
                                            ...
                                            <h1 className="sr-only sr-only-focusable">{this.state.storeName}</h1>
                                        </span>
                                    ) : (
                    ...
                    <Grid>
                        ...
                        <Row className={"double-cta" + (this.props.optionsData.acf.hide_jobs_cta ? " hide-jobs" : '')}>
                            <Col xs={12} sm={6} className="col store-jobs-cta background-color-setter-lighter border-color-setter-lighter" onClick={this.openJobs.bind(this)}>
                                <h2>Jobs</h2>
                            </Col>

                            <Col xs={12} sm={6} className="col store-sales-cta background-color-setter-lighter border-color-setter-lighter" onClick={this.openSales.bind(this)}>
                                <h2>Sales & Offers</h2>
                            </Col>
                        </Row>
                        ...
                        <Row className="store-info">
                            {this.state.restaurantMenu ? ( // if there is a restaurant menu, print 4 columns, else print 3 columns
                                <div>
                                        ...
                                        {this.state.phoneNumber ? (
                                            <div>
                                                <a href={'tel:' + this.state.phoneNumber} className="font-color-setter">
                                                    <svg id="phone-icon" className="store-icon" viewBox="0 0 165 165">
                                        ...
                                        {this.state.printableDirectory ?
                                            (
                                                <a href={this.state.printableDirectory} target="_blank">
                                                    <svg id="location-icon" className="store-icon" viewBox="0 0 165 165">
                                                        <circle className="cls-1 border-color-setter" cx="82.5" cy="83.06" r="79.8"/>
                                    ...
                                    <Col xs={12} sm={4}>
                                        <svg id="menu-icon" className="store-icon" viewBox="0 0 165 165">
                                            <circle className="cls-1 border-color-setter" cx="82.5" cy="83.06" r="79.8"/>
                                            <path className="cls-2 background-color-setter"
                                ...
                                <div>
                                    ...
                                    <div className="hours-container border-color-setter">
                                        <Hours optionsData={this.props.storeData.acf.custom_hours ? this.props.storeData : this.props.optionsData} isStore={true} data={this.state.data} />
                                    </div>
