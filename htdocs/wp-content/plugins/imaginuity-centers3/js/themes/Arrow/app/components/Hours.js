    ...
    buildHours(hoursData){
        ...
        function checkDays(day1, day2, dayTitle){
            if(day1 && day2 === ''){
                ...
                hourOfDay = day2;
                return (day2 !== 0 ? daysOfWeek + ' / ' : daysOfWeek);
            }
        }
                        ...
                        <Row>
                            <Col xs={12}>
                                {this.state.customHoursMessage ? (
                                    ...
                                    <p className="font-color-setter">
                                        <span>Hours</span>
                                        {this.state.hours.specialInstructions ? <br/> : ''}
                                        {this.state.hours.specialInstructions ? this.state.hours.specialInstructions : ''}
                                        {this.state.hours.specialInstructions ? <br/> : ''}
                                        {this.state.hours.daysDisplay}
                                    </p>
                                )}
