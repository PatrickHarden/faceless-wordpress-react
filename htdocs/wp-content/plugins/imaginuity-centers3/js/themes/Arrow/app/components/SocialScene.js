                        ...
                        {this.props.fb &&
                            <Col xs={12} md={2} mdOffset={offset} >
                                <a href={this.props.fb} target="_blank" title="facebook">
                                    <svg id="facebook-icon" className="store-icon" alt="facebook icon"  viewBox="0 0 165 165">
                                        <defs>
                                            <style>
                                                </style>
                        ...
                        {this.props.tw &&
                            <Col xs={12} md={2} smOffset={social.length == 1 ? 5 : 0} >
                                <a href={this.props.tw} target="_blank" title="twitter">
                                    <svg id="twitter-icon" className="store-icon" alt="twitter icon" viewBox="0 0 165 165">
                                        <defs>
                        ...
                        {this.props.ig &&
                            <Col xs={12} md={2} smOffset={social.length == 1 ? 5 : 0} >
                                <a href={this.props.ig} target="_blank" title="instagram">
                                    <svg id="instagram-icon" className="store-icon" alt="instagram icon" viewBox="0 0 165 165">
                                        <defs>
                        ...
                        {this.props.pn &&
                            <Col xs={12} md={2} smOffset={social.length === 1 ? 5 : 0} >
                                <a href={this.props.pn} target="_blank" title="pinterest">
                                    <svg id="pinterest-icon" className="store-icon" alt="pinterest incon" viewBox="0 0 165 165">
                                        <defs>
