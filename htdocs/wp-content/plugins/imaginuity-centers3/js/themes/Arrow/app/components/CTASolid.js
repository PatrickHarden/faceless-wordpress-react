...
class CTASolid extends Component{
    ...
    render(){
        let buttonLink = (this.props.ctaData.acf.cta2_button_link === 'Internal') ? this.props.ctaData.acf.cta2_internal_link : this.props.ctaData.acf.cta2_external_link;
        return(
                ...
                <Grid>
                    <Row>
                        <Col xs={12}>
                            ...
                            <Button className="border-color-white btn" href={buttonLink} target={(this.props.ctaData.acf.cta2_button_link === 'Internal' ? '_self' :'_blank')}  >{this.props.ctaData.acf.cta2_button_text ? this.props.ctaData.acf.cta2_button_text : 'Sign Me Up'}</Button>
                        </Col>
                    </Row>
                </Grid>
            </div>
