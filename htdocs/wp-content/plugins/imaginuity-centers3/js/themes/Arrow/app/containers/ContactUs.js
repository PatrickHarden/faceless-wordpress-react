...
class ContactUs extends Component {
    ...
    render() {
        if(this.state.data){
            return (
                <div className="template-contact-us" data-page="contact-us">
                    <Helmet
                    ...
                    <Grid className="main-layout font-color-setter">
                        <Row>
                            <Col xs={12} sm={6}>
                                <section dangerouslySetInnerHTML={{ __html: entities.decode(this.state.pageData.acf.layout_type[0].content_area)}} />
                            </Col>
